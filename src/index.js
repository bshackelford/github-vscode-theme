...
const getBShackTheme = require("./bshack/theme");
...
const bshackLightTheme = getBShackTheme({
  style: "light",
  name: "BShack Light",
});

const bshackDarkTheme = getBShackTheme({
  style: "dark",
  name: "BShack Dark",
});
...
fs.mkdir("./themes", { recursive: true })
  .then(() => Promise.all([
    ...
    fs.writeFile("./themes/bshack-light.json", JSON.stringify(bshackLightTheme, null, 2)),
    fs.writeFile("./themes/bshack-dark.json", JSON.stringify(bshackDarkTheme, null, 2)),
  ]))
